...
class DiffusionModel(keras.Model):
    ...
    def train_step(self, images):
        ...
        tf.print("Grad norm:", tf.linalg.global_norm(gradients))
        print("Trainable weights:", len(self.network.trainable_weights))
        #print("Noise loss:", noise_loss.numpy())
        tf.print("Noise loss:", noise_loss)
